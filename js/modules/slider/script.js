var obSlider = {
    ...
    nextArrow: '<a href="javascript:void(0)" class="arrow-left"><i class="icon icon-arrow-full-white"></i><i class="icon icon-arrow-full-black"></i></a>',

    prevArrow: '<a href="javascript:void(0)" class="arrow-right"><i class="icon icon-arrow-full-white"></i><i class="icon icon-arrow-full-black"></i></a>',
